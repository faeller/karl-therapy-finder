...
.day {
  ...
  &.active {
    @apply bg-linear-to-tr from-green-300 via-green-400 to-green-500 shadow-sm dark:from-green-400 dark:via-green-500 dark:to-green-800 dark:shadow-green-800;
  }
}
