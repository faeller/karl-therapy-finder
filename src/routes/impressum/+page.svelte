...
<svelte:head>
	<title>Impressum & AGB - KARL</title>
</svelte:head>
	...
	<div class="mx-auto max-w-3xl">
		...
		<WobblyCard class="prose prose-pencil max-w-none">
			...
			<div class="info-box">
				...
				<p>
					<strong>KARL - Kontakt Automatisierung Richtung Leben - Merle Fäller</strong><br>
			...
			<p>
				<strong>Zuständige Regulierungs- und Aufsichtsbehörde:</strong> Bayerische Landeszentrale für neue Medien<br>
				<strong>Sitz:</strong> Deutschland
			</p>

			<div class="info-box">
				<h3>Geltungsbereich</h3>
				<p>Das hier angegebene Impressum gilt für alle Belange der Impressumspflicht nach §5 DDG, § 55 Abs.2 RStV & MStV §18 sowie für alle Social Media Auftritte des Creators.</p>
			</div>
